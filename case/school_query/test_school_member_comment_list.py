...
class TestSchoolMemberCommentlist(unittest.TestCase):
    ...
    def test_school_member_common_list(self):
        '''
        测试热门院校接口
        '''
        url = "/school/memberCommentList"
        headers = {
